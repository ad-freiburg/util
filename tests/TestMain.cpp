...

{
...

  {
    ...
    XSortedPolygon<int> spoly5(poly5);
      ...
      TEST(std::get<0>(geo::intersectsContainsCovers(anothertestx2, anotherboxx2)));
      TEST(std::get<0>(geo::intersectsContainsCovers(anotherboxx2, anothertestx2)));

      TEST(std::get<0>(geo::intersectsContainsCovers(anothertestx2, anotherboxx2m)));
      TEST(std::get<0>(geo::intersectsContainsCovers(anotherboxx2m, anothertestx2)));

      TEST(std::get<0>(geo::intersectsContainsCovers(anothertestx2, anotherboxx2mp)));
      TEST(std::get<0>(geo::intersectsContainsCovers(anotherboxx2mp, anothertestx2)));
